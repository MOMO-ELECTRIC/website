const i18n = {
  zh: {
    ...
    ctaCall: '立即获取报价',
    ctaRebate: '了解 SCE 免费电箱升级',
    metaLicense: 'CSLB LICENSE #1147309',
    metaSce: 'SCE 认证',
    metaSceText: 'SCE EV CHARGE READY PROGRAM 认证安装商，助力南加州家庭向清洁能源迈进。',
    metaTesla: 'Tesla 认证',
    metaTeslaText: '具备 Tesla 相关电力项目施工经验，熟悉高标准现场交付要求。',
    metaAnker: 'Anker 认证',
    metaAnkerText: '具备 Anker 储能系统安装经验，重视规范、性能与长期稳定运行。',
    ...
    panelRebateNote: '服务亮点：包 permit、包验收、包恢复墙面、包充电桩安装，让客户省心完成升级。',
  ...
  en: {
    ...
    metaSceText: 'Certified installer for the SCE EV Charge Ready Program, helping Southern California homes move toward clean energy.',
    metaTesla: 'Tesla Certified',
    metaTeslaText: 'Experienced with Tesla-related electrical projects and high-standard field delivery requirements.',
    metaAnker: 'Anker Certified',
    metaAnkerText: 'Experienced with Anker energy storage installations, with a focus on code, performance, and long-term reliability.',
    ...
    rebateCtaApply: 'Submit Rebate Application Now',
    ...
    panelRebateNote: 'Key benefits: permit included, inspection included, wall restoration included, and EV charger installation included.',
    panelContactKicker: 'CONTACT US',
