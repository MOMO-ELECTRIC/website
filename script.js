const i18n = {
  zh: {
    ...
    panelServicesItem1Title: 'On Site 查勘及准确报价',
    panelServicesItem1: '现场查勘更清楚、范围判断更准确、报价更直接，尽量把前期不确定性消化掉。',
    panelServicesItem2Title: '数百 CITY PERMIT PULLING 案例',
    panelServicesItem2: '有大量实际 permit 申报与推进经验，熟悉城市审批流程和常见要求。',
    panelServicesItem3Title: '高标准施工',
    panelServicesItem3: '现场施工讲究工艺、整洁和执行标准，不做看上去凑合、后面返工的活。',
    panelServicesItem4Title: '完全遵守 CODE 要求，熟悉 AHJ Inspection',
    panelServicesItem4: '从施工开始就按规范落地，熟悉 AHJ inspection 节奏，减少验收阶段的来回折腾。',
  ...
  en: {
    ...
    panelServicesItem1Title: 'On-Site Assessment & Accurate Quote',
    panelServicesItem1: 'Clear on-site evaluation, practical scope review, and accurate pricing before work begins.',
    panelServicesItem2Title: 'Hundreds of City Permit Pulling Cases',
    panelServicesItem2: 'Extensive real-world experience handling city permit pulls and navigating approval requirements.',
    panelServicesItem3Title: 'High-Standard Construction',
    panelServicesItem3: 'Clean, organized field execution with workmanship standards built to last.',
    panelServicesItem4Title: 'Code Compliance & Strong AHJ Inspection Experience',
    panelServicesItem4: 'Delivered to code from the start, with solid AHJ inspection experience to reduce surprises at sign-off.',
